...
ACTIVISM_KEYWORDS = [
    ...
    "지배구조", "자사주", "배당", "이사회", "주주총회","경영권 확보", "지분 확보", "지분 매입", "지분 확대", 
    "적대적 인수합병", "우호 지분", "임시주총", "소송", "감사 선임", "사내이사", 
    "사외이사", "대표이사 교체", "사내이사 선임", "사외이사 추천", "지배력",
    "경영간섭", "최대주주 변경", "의결권 위임", "주주제안", "경영진 교체",
    "배당 확대", "현금 배당", "자본 재편", "기업가치 제고", "주가 부양", 
    "합병 반대", "분할 반대", "이사 해임", "경영참여", "의결권 행사"
]
